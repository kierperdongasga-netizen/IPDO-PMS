...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    secondary: "bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 focus:ring-blue-900",
    outline: "bg-transparent border border-blue-900 text-blue-900 hover:bg-blue-50 focus:ring-blue-900",
